...
void AddForm::on_pushButton_clicked() {
  std::ofstream out;
  out.open("//home//propolisss//baumana//aip//2_semestr//practice//practice_1//practice_1//data_base.txt", std::ios_base::app);
  ...
  out.close();
  ((Widget*) parentForm)->setDataBase(surname, name, phone, adress, true);
}
